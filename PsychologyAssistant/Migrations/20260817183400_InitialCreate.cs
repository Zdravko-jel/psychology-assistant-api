        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmContactPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoodLevels = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AnxietyLevels = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DepressionLevels = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SleepQualityLevels = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientFiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SleepQualityLevel = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sessions_PatientFiles_PatientFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Symptoms_PatientFiles_PatientFileId",
                        column: x => x.PatientFileId,
                        principalTable: "PatientFiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    TakenNote = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NoteSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientFiles_DiagnosisId",
                table: "PatientFiles",
                column: "DiagnosisId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_PatientFileId",
                table: "Sessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Symptoms_PatientFileId",
                table: "Symptoms",
                column: "PatientFileId");
        }
